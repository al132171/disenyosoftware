				...
				<div class="row contact-wrap">
					<div class="col-sm-10 col-sm-offset-1">
						<table style="width: 100%">
							...
							<c:forEach items="${procesador}" var="pr" varStatus="loopStatus">
								<tr bgcolor="${loopStatus.index % 2 == 0 ? '' : '#F0F0F0'}">
									<td><h5>${pr.modelo}</h5></td>
									<td><h5>${pr.nucleos}</h5></td>
									<td><h5>${pr.frecuencia}</h5></td>
									<td><h5>${pr.socket}</h5></td>
									<td><h5>${pr.precio}€</h5></td>
									<td><h5>
											<a
												href="${pageContext.request.contextPath}/administracion/editaProcesador/${pr.id}.html">Edita</a>
										</h5></td>
								</tr>
							</c:forEach>
