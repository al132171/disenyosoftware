...
<%@page import="es.uji.ei1038.ujinformatica.dominio.Monitor"%>
				...
				<div class="row contact-wrap">
					<div class="col-sm-5 col-sm-offset-1">
						<form:form id="add-placa-form" class="contact-form"
							name="admin-form" method="post" modelAttribute="monitor">
							<div class="form-group">
								<form:label path="pantalla">Tipo de pantalla</form:label>
								<form:input path="pantalla" type="text" name="pantalla"
									class="form-control" required="required" maxlength="20" />
								<form:errors path="pantalla" class="error" />
							</div>
							<div class="form-group">
								<form:label path="tamanyo">Tamaño</form:label>
								<form:input path="tamanyo" type="text" name="tamanyo"
									class="form-control" required="required" maxlength="20" />
								<form:errors path="tamanyo" class="error" />
							</div>
							<div class="form-group">
								<form:label path="resolucion">Resolución</form:label>
								<form:input path="resolucion" type="text" name="resolucion"
									class="form-control" required="required" maxlength="10" />
								<form:errors path="resolucion" class="error" />
							</div>
							<div class="form-group">
