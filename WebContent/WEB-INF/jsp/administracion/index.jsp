			...
			<div class="container">
				<div class="center">
					<div class="get-started center wow animated"
						...
						<h2>Administración de Appujimática.com</h2>
						<p class="lead"></p>
					</div>
				</div>
				<h2>Bienvenido: ${identificador}</h2>
				<h3>Instrucciones</h3>
				<p>El menú de administración de AppUjimática, le permite:</p>
				<ul>
					<li>
						<p>Añadir componentes al catalogo y la simulación.</p>
					</li>
					<li>
						<p>Listar y modificar los productos existentes.</p>
					</li>
					<li>
						<p>Realizar configuraciones de ordenadores.</p>
					</li>
					<li>
						<p>Desconectarse del sistema.</p>
					</li>
				</ul>
			</div>
			<!--/.container--> </section>
