					...
					<div class="col-sm-10 col-sm-offset-1">
						<table style="width: 100%">
							<tr bgcolor="#C4C4C4">
								...
								<td><h4>Velocidad escritura</h4></td>
								<td><h4>Precio</h4></td>
								<td><h4>Editar</h4></td>
							</tr>
							<c:forEach items="${dvd}" var="dvd" varStatus="loopStatus">
								<tr bgcolor="${loopStatus.index % 2 == 0 ? '' : '#F0F0F0'}">
									<td><h5>${dvd.tipo}</h5></td>
									<td><h5>${dvd.interfaz}</h5></td>
									<td><h5>${dvd.velocidadEscritura}</h5></td>
									<td><h5>${dvd.precio}€</h5></td>
									<td><h5>
											<a
												href="${pageContext.request.contextPath}/administracion/editaUnidadDVD/${dvd.id}.html">Edita</a>
										</h5></td>
								</tr>
							</c:forEach>
