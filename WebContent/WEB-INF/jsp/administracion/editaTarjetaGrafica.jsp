...
<%@page import="es.uji.ei1038.ujinformatica.dominio.TarjetaGrafica"%>
			...
			<div class="container">
				<div class="center">
					<div class="get-started center wow animated"
						...
						<p class="lead">Editar tarjeta gráfica</p>
					</div>
				</div>
				...
				<div class="row contact-wrap">
					<div class="col-sm-5 col-sm-offset-1">
						<form:form id="add-placa-form" class="contact-form"
							name="admin-form" method="post" modelAttribute="tarjetaGrafica">
							<div class="form-group">
								<form:label path="chipset">Marca y chipset</form:label>
								<form:input path="chipset" type="text" maxlength="20"
									name="chipset" class="form-control" required="required" />
								<form:errors path="chipset" class="error" />
							</div>
							<div class="form-group">
								<form:label path="memoria">Memoria en MB</form:label>
								<form:input path="memoria" type="number" step="1" min="1"
									name="memoria" class="form-control" required="required" />
								<form:errors path="memoria" class="error" />
							</div>
							<div class="form-group">
								<form:label path="tipoMemoria">Tipo de memoria</form:label>
								<form:input path="tipoMemoria" type="text" maxlength="20"
									name="tipoMemoria" class="form-control" required="required" />
								<form:errors path="tipoMemoria" class="error" />
							</div>
							<div class="form-group">
								<form:label path="bus">Bus</form:label>
								<form:input path="bus" type="text" maxlength="20" name="bus"
									class="form-control" required="required" />
								<form:errors path="bus" class="error" />
							</div>
							<div class="form-group">
