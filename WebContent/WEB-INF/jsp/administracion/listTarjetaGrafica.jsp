						...
						<table style="width: 100%">
							...
							<c:forEach items="${tarjetaGrafica}" var="tj"
								...
								<tr bgcolor="${loopStatus.index % 2 == 0 ? '' : '#F0F0F0'}">
									<td><h5>${tj.chipset}</h5></td>
									<td><h5>${tj.memoria}</h5></td>
									<td><h5>${tj.tipoMemoria}</h5></td>
									<td><h5>${tj.bus}</h5></td>
									<td><h5>${tj.precio}€</h5></td>
									<td><h5>
											<a
												href="${pageContext.request.contextPath}/administracion/editaTarjetaGrafica/${tj.id}.html">Edita</a>
										</h5></td>
								</tr>
							</c:forEach>
