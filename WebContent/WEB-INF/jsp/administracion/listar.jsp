			...
			<div class="container">
				<div class="center">
					<div class="get-started center wow animated"
						...
						<p class="lead">Puedes consultar los componentes disponibles y
							editarlos.</p>
					</div>
				</div>
						...
						<div class="recent-work-wrap">
							...
							<div class="overlay">
								<div class="recent-work-inner">
									...
									<a class="preview"
										href="${pageContext.request.contextPath}/administracion/listPlacasBase.html"><i
										class="fa fa-eye"></i> Listar</a>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="overlay">
								<div class="recent-work-inner">
									...
									<p>Los últimos procesadores del mercado los encontrarás
										aquí</p>
									<a class="preview"
										href="${pageContext.request.contextPath}/administracion/listProcesador.html"><i
										class="fa fa-eye"></i> Listar</a>
								</div>
							</div>
						</div>
						...
						<div class="recent-work-wrap">
							...
							<div class="overlay">
								<div class="recent-work-inner">
									...
									<a class="preview"
										href="${pageContext.request.contextPath}/administracion/listRam.html"><i
										class="fa fa-eye"></i> Listar</a>
								</div>
							</div>
						</div>
						...
						<div class="recent-work-wrap">
							...
							<div class="overlay">
								<div class="recent-work-inner">
									...
									<a class="preview"
										href="${pageContext.request.contextPath}/administracion/listDiscoDuro.html"><i
										class="fa fa-eye"></i> Listar</a>
								</div>
							</div>
						</div>
						...
						<div class="recent-work-wrap">
							...
							<div class="overlay">
								<div class="recent-work-inner">
									...
									<a class="preview"
										href="${pageContext.request.contextPath}/administracion/listTarjetaGrafica.html"><i
										class="fa fa-eye"></i> Listar</a>
								</div>
							</div>
						</div>
						...
						<div class="recent-work-wrap">
							...
							<div class="overlay">
								<div class="recent-work-inner">
									...
									<a class="preview"
										href="${pageContext.request.contextPath}/administracion/listMonitor.html"><i
										class="fa fa-eye"></i> Listar</a>
								</div>
							</div>
						</div>
						...
						<div class="recent-work-wrap">
							...
							<div class="overlay">
								<div class="recent-work-inner">
									...
									<a class="preview"
										href="${pageContext.request.contextPath}/administracion/listDvd.html"><i
										class="fa fa-eye"></i> Listar</a>
								</div>
							</div>
						</div>
							...
							<div class="overlay">
								<div class="recent-work-inner">
									...
									<p>Multiples periféricos para completar la funcionalidad de
										tu pc</p>
									<a class="preview"
										href="${pageContext.request.contextPath}/administracion/listOtros.html"><i
										class="fa fa-eye"></i> Listar</a>
								</div>
							</div>
						</div>
