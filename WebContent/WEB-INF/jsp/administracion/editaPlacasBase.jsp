...
<%@page import="es.uji.ei1038.ujinformatica.dominio.PlacaBase"%>
			...
			<div class="container">
				<div class="center">
					<div class="get-started center wow animated"
						...
						<p class="lead">Editar placas base</p>
					</div>
				</div>
				...
				<div class="row contact-wrap">
					<div class="col-sm-5 col-sm-offset-1">
						<form:form id="add-placa-form" class="contact-form"
							name="admin-form" method="post" modelAttribute="placaBase">
							<div class="form-group">
								<form:label path="modelo">Modelo</form:label>
								<form:input path="modelo" type="text" name="modelo"
									maxlength="20" class="form-control" required="required" />
								<form:errors path="modelo" class="error" />
							</div>
							<div class="form-group">
								<form:label path="socketProcesador">Socket del procesador</form:label>
								<form:input path="socketProcesador" type="text" maxlength="20"
									name="socketProcesador" class="form-control"
									required="required" />
								<form:errors path="socketProcesador" class="error" />
							</div>
							<div class="form-group">
								<form:label path="interfazDiscoDuro">Interfaz HDD</form:label>
								<form:input path="interfazDiscoDuro" type="text" maxlength="20"
									name="interfazDiscoDuro" class="form-control"
									required="required" />
								<form:errors path="interfazDiscoDuro" class="error" />
							</div>
							<div class="form-group">
								<form:label path="tipoRam">Tipo de RAM</form:label>
								<form:input path="tipoRam" type="text" maxlength="20"
									name="tipoRam" class="form-control" required="required" />
								<form:errors path="tipoRam" class="error" />
							</div>
							<div class="form-group">
								<form:label path="interfazDvd">Interfaz DVD</form:label>
								<form:input path="interfazDvd" type="text" maxlength="20"
									name="interfazDvd" class="form-control" required="required" />
								<form:errors path="interfazDvd" class="error" />
							</div>
							<div class="form-group">
								<form:label path="busTj">Bus de la tarjeta gráfica</form:label>
								<form:input path="busTj" type="text" maxlength="20" name="busTj"
									class="form-control" required="required" />
								<form:errors path="busTj" class="error" />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<button type="submit" name="submit"
									class="btn btn-primary btn-lg" required="required">Editar</button>
							</div>
						</form:form>
					</div>
				</div>
