		...
		<c:otherwise>
			...
			<div class="container" id="listado">
				<div class="center wow fadeInDown">
					<h2>Discos duros</h2>
					<p class="lead">Listado de caracterí­sticas y precios</p>
				</div>
				...
				<div class="row contact-wrap">
					<div class="col-sm-10 col-sm-offset-1">
						<table style="width: 100%">
							...
							<c:forEach items="${discoDuro}" var="dd" varStatus="loopStatus">
								<tr bgcolor="${loopStatus.index % 2 == 0 ? '' : '#F0F0F0'}">
								<tr>
									<td><h5>${dd.interfaz }</h5></td>
									<td><h5>${dd.capacidad }</h5></td>
									<td><h5>${dd.cache }</h5></td>
									<td><h5>${dd.rpm }</h5></td>
									<td><h5>${dd.precio }€</h5></td>
									<td><h5>
											<a
												href="${pageContext.request.contextPath}/administracion/editaDiscoDuro/${dd.id}.html">Edita</a>
										</h5></td>
								</tr>
							</c:forEach>
						</table>
