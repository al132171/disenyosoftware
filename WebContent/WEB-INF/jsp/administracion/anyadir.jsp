			...
			<div class="container">
				<div class="center">
					<div class="get-started center wow animated"
						...
						<p class="lead">Selecciona el tipo de componente a añadir.</p>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-4 col-md-3">
						<div class="recent-work-wrap">
							<img class="img-responsive"
								src="${pageContext.request.contextPath}/images/componentes/thumbs/placa.png"
								alt="">
							<div class="overlay">
								<div class="recent-work-inner">
									...
									<a class="preview"
										href="${pageContext.request.contextPath}/administracion/anyadirPlacasBase.html"><i
										class="fa fa-eye"></i> Añadir placa base</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-4 col-md-3">
						<div class="recent-work-wrap">
							<img class="img-responsive"
								src="${pageContext.request.contextPath}/images/componentes/thumbs/procesador.png"
								alt="">
							<div class="overlay">
								<div class="recent-work-inner">
									<h3>
									...
									<p>Los últimos procesadores del mercado los encontrarás
										aquí</p>
									<a class="preview"
										href="${pageContext.request.contextPath}/administracion/anyadirProcesador.html"><i
										class="fa fa-eye"></i> Añadir procesador</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-4 col-md-3">
						<div class="recent-work-wrap">
							<img class="img-responsive"
								src="${pageContext.request.contextPath}/images/componentes/thumbs/ram.png"
								alt="">
							<div class="overlay">
								<div class="recent-work-inner">
									<h3>
									...
									<a class="preview"
										href="${pageContext.request.contextPath}/administracion/anyadirRam.html"><i
										class="fa fa-eye"></i> Añadir memoria ram</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-4 col-md-3">
						<div class="recent-work-wrap">
							<img class="img-responsive"
								src="${pageContext.request.contextPath}/images/componentes/thumbs/hdd.png"
								alt="">
							<div class="overlay">
								<div class="recent-work-inner">
									<h3>
									...
									<p>
										- Discos duros internos<br>- Discos duros externos
									</p>
									<a class="preview"
										href="${pageContext.request.contextPath}/administracion/anyadirDiscoDuro.html"><i
										class="fa fa-eye"></i> Añadir disco duro</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-4 col-md-3">
						<div class="recent-work-wrap">
							<img class="img-responsive"
								src="${pageContext.request.contextPath}/images/componentes/thumbs/grafica.png"
								alt="">
							<div class="overlay">
								<div class="recent-work-inner">
									<h3>
									...
									<a class="preview"
										href="${pageContext.request.contextPath}/administracion/anyadirTarjetaGrafica.html"><i
										class="fa fa-eye"></i> Añadir tarjeta gráfica</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-4 col-md-3">
						<div class="recent-work-wrap">
							<img class="img-responsive"
								src="${pageContext.request.contextPath}/images/componentes/thumbs/monitor.png"
								alt="">
							<div class="overlay">
								<div class="recent-work-inner">
									<h3>
									...
									<a class="preview"
										href="${pageContext.request.contextPath}/administracion/anyadirMonitor.html"><i
										class="fa fa-eye"></i> Añadir monitor</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-4 col-md-3">
						<div class="recent-work-wrap">
							<img class="img-responsive"
								src="${pageContext.request.contextPath}/images/componentes/thumbs/dvd.png"
								alt="">
							<div class="overlay">
								<div class="recent-work-inner">
									<h3>
										<a href="#">Lectoras/grabadoras de DVD</a>
									</h3>
									<p>Grabadoras para grabar tus ficheros o recuerdos</p>
									<a class="preview"
										href="${pageContext.request.contextPath}/administracion/anyadirUnidadDVD.html"><i
										class="fa fa-eye"></i> Añadir unidad dvd</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-4 col-md-3">
						<div class="recent-work-wrap">
							<img class="img-responsive"
								src="${pageContext.request.contextPath}/images/componentes/thumbs/otro.png"
								alt="">
							<div class="overlay">
								<div class="recent-work-inner">
									<h3>
										<a href="#">Otros periféricos</a>
									</h3>
									<p>Multiples periféricos para completar la funcionalidad de
										tu pc</p>
									<a class="preview"
										href="${pageContext.request.contextPath}/administracion/anyadirOtros.html"><i
										class="fa fa-eye"></i> Añadir periférico</a>
								</div>
							</div>
						</div>
					</div>
