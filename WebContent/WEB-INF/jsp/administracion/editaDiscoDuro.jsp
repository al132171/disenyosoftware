...
<%@page import="es.uji.ei1038.ujinformatica.dominio.DiscoDuro"%>
			...
			<div class="container">
				<div class="center">
					<div class="get-started center wow animated"
						...
						<p class="lead">Editar disco duro</p>
					</div>
				</div>
				...
				<div class="row contact-wrap">
					<div class="col-sm-5 col-sm-offset-1">
						<form:form id="add-placa-form" class="contact-form"
							name="admin-form" method="post" modelAttribute="discoDuro">
							<div class="form-group">
								<form:label path="capacidad">Capacidad en GB</form:label>
								<form:input path="capacidad" type="number" step="1" min="128"
									name="capacidad" class="form-control" required="required" />
								<form:errors path="capacidad" class="error" />
							</div>

							<div class="form-group">
								<form:label path="interfaz">Interfaz</form:label>
								<form:input path="interfaz" type="text" name="interfaz"
									class="form-control" required="required" maxlength="20" />
								<form:errors path="interfaz" class="error" />
							</div>

							<div class="form-group">
								<form:label path="cache">Caché en MB</form:label>
								<form:input path="cache" type="number" step="1" min="128"
									name="cache" class="form-control" required="required" />
								<form:errors path="cache" class="error" />
							</div>

							<div class="form-group">
								<form:label path="rpm">Revoluciones por minuto</form:label>
								<form:input path="rpm" type="number" step="1" min="0" name="rpm"
									class="form-control" required="required" maxlength="10" />
								<form:errors path="rpm" class="error" />
							</div>
