...
<%@page import="es.uji.ei1038.ujinformatica.dominio.Ram"%>
				...
				<div class="row contact-wrap">
					<div class="col-sm-5 col-sm-offset-1">
						<form:form id="add-placa-form" class="contact-form"
							name="admin-form" method="post" modelAttribute="ram">
							...
							<div class="form-group">
								...
								<form:input path="capacidad" type="number" min="1" step="1"
