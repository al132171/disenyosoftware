...
<%@page import="es.uji.ei1038.ujinformatica.dominio.Procesador"%>
			...
			<div class="container">
				<div class="center">
					<div class="get-started center wow animated"
						...
						<p class="lead">Editar procesador</p>
					</div>
				</div>
				...
				<div class="row contact-wrap">
					<div class="col-sm-5 col-sm-offset-1">
						<form:form id="add-placa-form" class="contact-form"
							name="admin-form" method="post" modelAttribute="procesador">
							<div class="form-group">
								<form:label path="marca">Marca</form:label>
								<form:input path="marca" type="text" maxlength="10" name="marca"
									class="form-control" required="required" />
								<form:errors path="marca" class="error" />
							</div>
							<div class="form-group">
								<form:label path="modelo">Modelo</form:label>
								<form:input path="modelo" type="text" maxlength="20"
									name="modelo" class="form-control" required="required" />
								<form:errors path="modelo" class="error" />
							</div>
							<div class="form-group">
								<form:label path="nucleos">Núcleos</form:label>
								<form:input path="nucleos" type="number" step="1" min="1"
									class="form-control" name="nucleos" required="required" />
								<form:errors path="nucleos" class="error" />
							</div>
							<div class="form-group">
								<form:label path="frecuencia">Frecuencia</form:label>
								<form:input path="frecuencia" type="text" maxlength="15"
									name="fecuencia" class="form-control" required="required" />
								<form:errors path="frecuencia" class="error" />
							</div>
							<div class="form-group">
								<form:label path="socket">Socket</form:label>
								<form:input path="socket" type="text" maxlength="15"
									name="socket" class="form-control" required="required" />
								<form:errors path="socket" class="error" />
							</div>
							<div class="form-group">
								<form:label path="precio">Precio €</form:label>
								<form:input path="precio" type="number" step="0.01" min="0"
									max="9999.99" class="form-control" required="required" />
