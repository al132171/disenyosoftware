				...
				<div class="row contact-wrap">
					<div class="col-sm-10 col-sm-offset-1">
						<table style="width: 100%">
							<tr bgcolor="#C4C4C4">
								<td><h4>Socket procesador</h4></td>
								<td><h4>Interfaz disco duro</h4></td>
								<td><h4>Tipo de RAM</h4></td>
								<td><h4>Interfaz DVD</h4></td>
								<td><h4>Bus tarjeta gráfica</h4></td>
								<td><h4>Modelo</h4></td>
								<td><h4>Precio</h4></td>
								<td><h4>Editar</h4></td>

							</tr>
							<c:forEach items="${placas}" var="placa" varStatus="loopStatus">
								<tr bgcolor="${loopStatus.index % 2 == 0 ? '' : '#F0F0F0'}">
									<td><h5>${placa.socketProcesador}</h5></td>
									<td><h5>${placa.interfazDiscoDuro}</h5></td>
									<td><h5>${placa.tipoRam}</h5></td>
									<td><h5>${placa.interfazDvd}</h5></td>
									<td><h5>${placa.busTj}</h5></td>
									<td><h5>${placa.modelo}</h5></td>
									<td><h5>${placa.precio}€</h5></td>
									<td><h5>
											<a
												href="${pageContext.request.contextPath}/administracion/editaPlacasBase/${placa.id}.html">Edita</a>
										</h5></td>
								</tr>
							</c:forEach>
