...
<%@page import="es.uji.ei1038.ujinformatica.dominio.Otros"%>
			...
			<div class="container">
				<div class="center">
					<div class="get-started center wow animated"
						...
						<p class="lead">Editar periféricos</p>
					</div>
				</div>
				...
				<div class="row contact-wrap">
					<div class="col-sm-5 col-sm-offset-1">
						<form:form id="add-placa-form" class="contact-form"
							name="admin-form" method="post" modelAttribute="otros">
							...
							<div class="form-group">
								<form:label path="datos">Descripción</form:label>
								<form:input path="datos" type="text" name="datos" maxlength="40"
									class="form-control" required="required" />
								<form:errors path="datos" class="error" />
							</div>
							<div class="form-group">
